...
function addProductToCart(title, price, productimage) {
  ...
  var carItemsNames = document.getElementsByClassName("product-title");
  ...
  var cartBoxContent = `
 <img src="./assets/kid/kid2.jpg" alt="" class="cart-img" />
 <div class="detail-box">
 <div class="card-product-title">shoes</div>
 <div class="cart-price">$50.90</div>
